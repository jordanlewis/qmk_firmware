...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  [_DEFAULT] = LAYOUT( /* qwerty */
    ...
    KC_LALT,  KC_NO,   KC_NO,   MO(_NAV),KC_LGUI,  KC_BSPC, KC_BSPC, KC_ENT,    KC_ENT,  KC_SPC,  KC_HYPR, KC_NO,   KC_LBRC, KC_RBRC
  ),
  ...
  [_NAV] = LAYOUT(
    ...
    KC_TRNS,       KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS,      KC_DEL,  KC_TRNS,  KC_TRNS,  KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN, KC_RGHT, TO(_RESET)
  ),
